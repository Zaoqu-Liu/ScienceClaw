...
| ドメイン | 数 | スキル |
|---------|-----|--------|
| **バイオインフォマティクス** | 30+ | `scanpy`、`anndata`、`deseq2`、`clusterProfiler`、`GSEA`、`arboreto`、`pyDESeq2` |
| **可視化** | 35+ | `volcano-plot`、`heatmap`、`km-survival-curve`、`forest-plot`、`circos-plot`、`manhattan-plot` |
| **創薬** | 20+ | `chembl-database`、`rdkit`、`zinc-database`、`alphafold-database`、`adaptyv`、`medchem` |
| **臨床・生存** | 15+ | `clinicaltrials-database`、`meta-analysis`、`survival-analysis`、`mendelian-randomization` |
| **シングルセル** | 10+ | `scanpy`、`scvi-tools`、`cellxgene-census`、`anndata`、`cell-type-annotation` |
| **ゲノミクス** | 15+ | `gene-database`、`ensembl-database`、`gwas-catalog`、`clinvar`、`variant-annotation` |
| **データベース** | 20+ | `uniprot-database`、`pdb-database`、`string-database`、`opentargets`、`reactome` |
| **機械学習** | 10+ | `scikit-learn`、`xgboost`、`feature-selection`、`shap-interpretation`、`aeon` |
